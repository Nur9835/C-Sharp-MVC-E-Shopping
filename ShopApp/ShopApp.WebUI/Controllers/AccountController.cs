    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                await _emailSender.SendEmailAsync(model.Email, "Hesabınızı Onaylayınız.", $"Lütfen email hesabınızı onaylamak için linke <a href='http://localhost:48572{callbackUrl}'>tıklayınız.</a>");
        ...
        public async Task<IActionResult> ForgotPassword(string Email)
        {
            ...
            if(user==null)
            {
                ...
                {
                    Title = "Forgot Password",
                    Message = "Email adresiyle kullanıcı bulunamadı ",
                    Css = "danger"
                });
                return View();
            }
            ...
            await _emailSender.SendEmailAsync(Email, "Reset Password.", $"Parolanızı yenilemek için linke <a href='http://localhost:48572{callbackUrl}'>tıklayınız.</a>");

            TempData.Put("message", new ResultMessage()
            {
                Title = "Forgot Password",
                Message = "Parola yenilemek için hesabınıza email gönderildi",
                Css = "warning"
            });
